...
Global $resetAllButton = GUICtrlCreateButton("Reset All", 376, 288, 115, 49, $BS_MULTILINE)
...
Global $showMenuOnFirstStartCheckbox = GUICtrlCreateCheckbox("Show Menu on First Start", 16, 136, 545, 17)
Global $Label4 = GUICtrlCreateLabel("Specifies whether the main menu is shown when a first instance of FP-QUICore is started.", 35, 152, 523, 20)
GUICtrlCreateGroup("", -99, -99, 1, 1)
...
Global $Label8 = GUICtrlCreateLabel("Height", 584, 192, 43, 20, $SS_CENTERIMAGE)
